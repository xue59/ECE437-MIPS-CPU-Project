...
add wave -noupdate -expand -group PC /system_tb/DUT/CPU/DP/new_pc
add wave -noupdate -expand -group PC /system_tb/DUT/CPU/DP/next_pc
add wave -noupdate -expand -group PC /system_tb/DUT/CPU/DP/BranchAddr
add wave -noupdate -expand -group PC /system_tb/DUT/CPU/DP/JumpAddr
...
add wave -noupdate -expand -group datapath /system_tb/DUT/CPU/dcif/flushed
...
add wave -noupdate -group alu /system_tb/DUT/CPU/DP/aluif/port_out
...
add wave -noupdate -group forward /system_tb/DUT/CPU/DP/fuif/rw_mem
add wave -noupdate -group forward /system_tb/DUT/CPU/DP/fuif/rw_wb
add wave -noupdate -group forward /system_tb/DUT/CPU/DP/fuif/ow_rdat1
add wave -noupdate -group forward /system_tb/DUT/CPU/DP/fuif/ow_rdat2
add wave -noupdate -group forward /system_tb/DUT/CPU/DP/fuif/regwrite_mem
add wave -noupdate -group forward /system_tb/DUT/CPU/DP/fuif/regwrite_wb
add wave -noupdate -group forward /system_tb/DUT/CPU/DP/fuif/mem_data
add wave -noupdate -group forward /system_tb/DUT/CPU/DP/fuif/wb_data
add wave -noupdate -group forward /system_tb/DUT/CPU/DP/fuif/replace_rs
add wave -noupdate -group forward /system_tb/DUT/CPU/DP/fuif/replace_rt
add wave -noupdate -group hazard /system_tb/DUT/CPU/DP/huif/freeze
add wave -noupdate -group hazard /system_tb/DUT/CPU/DP/huif/flush
add wave -noupdate -group hazard /system_tb/DUT/CPU/DP/huif/pcSrc
add wave -noupdate -group hazard /system_tb/DUT/CPU/DP/huif/bne
add wave -noupdate -group hazard /system_tb/DUT/CPU/DP/huif/zero
add wave -noupdate -group hazard /system_tb/DUT/CPU/DP/huif/dhit
add wave -noupdate -group hazard /system_tb/DUT/CPU/DP/huif/jumpSel
add wave -noupdate -group hazard /system_tb/DUT/CPU/DP/huif/instruction
...
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/rdat1_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/rdat2_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/next_pc_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/shamt_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/ALUOp_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/ihit
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/flush
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/aluSrc_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/RegDest_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/jumpSel_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/pcSrc_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/memToReg_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/RegWrite_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/jal_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/dREN_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/dWEN_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/imemREN_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/lui_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/bne_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/halt_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/rd_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/rt_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/rs_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/imm_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/instruction_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/instruction_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/freeze
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/rdat1_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/rdat2_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/next_pc_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/shamt_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/ALUOp_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/aluSrc_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/RegDest_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/jumpSel_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/pcSrc_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/memToReg_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/RegWrite_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/jal_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/dREN_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/dWEN_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/imemREN_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/lui_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/bne_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/halt_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/rd_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/rt_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/rs_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/imm_out
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/imm26_in
add wave -noupdate -group id_ex /system_tb/DUT/CPU/DP/ieif/imm26_out
...
add wave -noupdate -expand -group DCACHE_internal -expand /system_tb/DUT/CPU/CM/DCACHE/ht
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/i
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/offset
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/tag
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/ind
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/miss
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/available
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/next_available
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/row
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/next_row
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/hit_count
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/next_hit_count
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/state
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/next_state
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/left_tag
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/right_tag
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/left_data1
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/left_data2
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/right_data1
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/right_data2
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/left_dirty
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/left_valid
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/right_dirty
add wave -noupdate -expand -group DCACHE_internal /system_tb/DUT/CPU/CM/DCACHE/right_valid
add wave -noupdate -radix binary -childformat {{{/system_tb/DUT/CPU/CM/DCACHE/row_trunc[2]} -radix binary} {{/system_tb/DUT/CPU/CM/DCACHE/row_trunc[1]} -radix binary} {{/system_tb/DUT/CPU/CM/DCACHE/row_trunc[0]} -radix binary}} -subitemconfig {{/system_tb/DUT/CPU/CM/DCACHE/row_trunc[2]} {-radix binary} {/system_tb/DUT/CPU/CM/DCACHE/row_trunc[1]} {-radix binary} {/system_tb/DUT/CPU/CM/DCACHE/row_trunc[0]} {-radix binary}} /system_tb/DUT/CPU/CM/DCACHE/row_trunc
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {245400 ps} 0}
...
update
WaveRestoreZoom {0 ps} {677169 ps}
